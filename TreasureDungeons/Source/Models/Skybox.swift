...
class Skybox : Model {
    let vertexList : [Vertex] = [
        ...
        // Top
        Vertex( 1,  1,  1, 1, 0, 0, 1,  0.5, 0.0,  0, 1, 0), // 16
        Vertex( 1,  1, -1, 0, 1, 0, 1,  0.5, 0.33,  0, 1, 0), // 17
        Vertex(-1,  1, -1, 0, 0, 1, 1,  0.25, 0.33,  0, 1, 0), // 18
        Vertex(-1,  1,  1, 0, 0, 0, 1,  0.25, 0.0,  0, 1, 0), // 19
